    ...
    <div className='row justify-content-around border border-info'>
      ...
      <section className='col-7 row justify-content-start border my-1'>
        ...
        <section className='col-5 row justify-content-center border'>
          ...
          <img className="col-8 img-fluid border" alt="Loading..." src={props.friendFavoriteMovie} />
          <span className='col-12 text-center border '>movie title</span>
          <span className='col-12 text-center border mb-4'>movie date</span>
        </section>
      </section>
